...
<!-------------------------- Start your work below ---------------------------->
I chose apt_buildings because of the simplicity of the categories and that the corresponding answers are easy to interpret compared to the other data sets. For instance, I'm not too sure how I would use the cancer_sample data and what some of the terms mean. I also felt the most comfortable forming questions using the apt_building data set as it is more applicable to the daily life.
<!----------------------------------------------------------------------------->
...
<!-------------------------- Start your work below ---------------------------->
Do the increasing number of elevators correlate more to the number of stories or number of units? 
...
elevator_distribution <- apt_buildings %>% 
  filter(!is.na(no_of_elevators)) %>%
  ggplot(aes(no_of_elevators)) + 
  geom_histogram(bins = 30) 

# max(apt_buildings$no_of_elevators)???

print(elevator_distribution)
# I made a histogram to see how commonly elevators are used across apartment buildings
# It seems like most apartments do not have elevators which was not what I expected
