...
<!-------------------------- Start your work below ---------------------------->
I chose apt_buildings because of the simplicity of the categories and that the corresponding answers are easy to interpret compared to the other data sets. For instance, I'm not too familiar with some of the terms in the cancer_sample data. I also felt the most comfortable forming questions using the apt_building data set as it is more applicable to daily life.
<!----------------------------------------------------------------------------->
...
<!-------------------------- Start your work below ---------------------------->
Does the increasing number of elevators correlate more with the number of stories or the number of units? 
<!----------------------------------------------------------------------------->
...
<!--- *****START HERE***** --->
1. Does the increasing number of elevators correlate more with the number of stories or the number of units?
