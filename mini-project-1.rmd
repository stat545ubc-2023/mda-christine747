...
## Relationship between the number of units and number of stories.
...
# With increasing storeys, there doesn't seem to be an increase in the number of elevators. The majority of buildings have around the same amount of elevators. 
```
...
```{r new tibble}
# I created a tibble with only the number of elevators, number of units, and number of storeys in a building.

elevator_units_storey <- apt_buildings %>%
